      ...
      <div style="position: relative; top: 60px;width: 100%;height: 120px;">
        ...
        <x-dialog v-model="showHideOnBlur" class="dialog-demo">
          ...
          <div @click="showHideOnBlur=false">
            <span class="vux-close" v-bind:style="closeMargin"></span>
          </div>
        </x-dialog>
  ...
  export default {
    ...
    mounted () {
      ...
      t.xhr.getPost({
        ...
        act: 'home/surl',
        data: {
          url: 'http://dmyzs.test.juefei88.com/h5/#/' + t.myStorage.getLocal('openid')
        }
      }, function (data) {
        t.l(data, 111)
...
//        )
      ...
      t.xhr.getPost({
        ...
        that.person_home = 'http://dmyzs.test.juefei88.com/h5/#/' + data.data.user[0].openid
      })
